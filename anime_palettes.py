# -*- coding: utf-8 -*-
"""anime_palettes —— 动漫/游戏角色配色库（58 套 × 6 主色）
...
PALETTES = {
  ...
  "robin-goldfeather": {
    "slug": 'robin-goldfeather',
    "zh": '知更鸟',
    "en": 'Robin',
    "tone_zh": '金羽',
    "tone_en": 'Gold Feather',
    "name_zh": '知更鸟 · 金羽',
    "name_en": 'Robin · Gold Feather',
    "family": '黄',
    "source": '崩坏：星穹铁道',
    "kind": 'cat',
    "colors": ['#DCB243', '#7F5E00', '#9A8B5B', '#BCB7AA', '#B06F85', '#4A5A8C'],
    "dark": ['#B08A12', '#543C00', '#726536', '#948F82', '#884960', '#223867'],
    "light": ['#FFE0A2', '#A78747', '#C3B68F', '#E8E4D9', '#D39EAE', '#7882AC'],
    "bg": '#F9F4EE',
    "bg2": '#EDE4D6',
    "ink": '#3D3113',
    "muted": '#8C8373',
    "seq": ['#FCF6EB', '#F7ECD8', '#F1E1C4', '#EBD7B0', '#E5CC9B', '#DCBF83', '#D2B168', '#C9A650', '#BF9A35', '#B18C1C', '#A27F14', '#94730D', '#856704', '#795C00', '#6A5101', '#5C4502', '#503B02', '#443200', '#443200'],
    "div": ['#3A415D', '#495379', '#596795', '#6E7AAA', '#848FBD', '#9CA5CD', '#B6BCDC', '#CFD2E8', '#E7E8F2', '#EBE8E5', '#DBD3C2', '#C8BDA1', '#B3A682', '#9E9066', '#897B51', '#74683D', '#5F5432', '#4A4228', '#4A4228'],
    "flow": ['#FFE8BE', '#FEDFAB', '#F3D6AC', '#E6CCAC', '#DAC4AD', '#D3BCA6', '#D1B299', '#CEA88D', '#CB9D80', '#C89276', '#C78A75', '#C48376', '#BF7C78', '#BA757A', '#B36F7C', '#AB697F', '#A4627A', '#9F576E', '#9B4C60', '#944153', '#8C3A4D', '#843953', '#783957', '#6B395B', '#5E3A5B', '#513A5A', '#453957', '#3B3852', '#33374C', '#31364A'],
    "cyclic": ['#B3914F', '#A8954F', '#9B9950', '#8B9D56', '#79A160', '#63A46D', '#4BA67D', '#2FA88D', '#00A89D', '#00A7AA', '#00A5B8', '#00A4C7', '#10A1D5', '#469DDA', '#6398DB', '#7A94DA', '#8D90D6', '#9E8BD1', '#AE86C8', '#BE81BD', '#CB7DAD', '#D57A9C', '#D97A8B', '#D97B7C', '#D67E6F', '#D08264', '#C9865B', '#C08B55', '#B69050', '#B3914F'],
    "wheel": [{'i': 0, 'L': 74.5, 'C': 60.2, 'h': 86.4}, {'i': 1, 'L': 42.0, 'C': 50.0, 'h': 83.3}, {'i': 2, 'L': 58.1, 'C': 27.8, 'h': 93.1}, {'i': 3, 'L': 74.5, 'C': 7.3, 'h': 94.2}, {'i': 4, 'L': 54.3, 'C': 28.8, 'h': 357.5}, {'i': 5, 'L': 39.0, 'C': 30.8, 'h': 285.3}],
    "ramp_stats": {'seq': {'L_range': 75.1, 'L_min': 22.0, 'L_max': 97.1, 'monotonic': True, 'total_dE': 100.5, 'uniformity': 0.749}, 'div': {'L_range': 67.6, 'L_min': 28.0, 'L_max': 95.6, 'monotonic': False, 'total_dE': 151.3, 'uniformity': 0.695}, 'flow': {'L_range': 69.9, 'L_min': 22.9, 'L_max': 92.9, 'monotonic': True, 'total_dE': 117.9, 'uniformity': 0.638}, 'cyclic': {'L_range': 0.6, 'L_min': 61.7, 'L_max': 62.3, 'monotonic': True, 'total_dE': 162.2, 'uniformity': 0.684}},
    "cvd_grade": 'A',
    "safe_set": [0, 1, 2, 3, 4, 5],
    "orders": {'smooth': [0, 1, 2, 3, 4, 5], 'distinct': [0, 2, 1, 5, 4, 3], 'hue': [1, 0, 2, 5, 4, 3], 'light': [0, 3, 2, 4, 1, 5]},
    "min_de": 17.5,
    "cvd": {'protan': 16.5, 'deutan': 16.3, 'tritan': 12.6},
  },
  "luigi-grass": {
    "slug": 'luigi-grass',
    "zh": '路易吉',
  ...
  "jiyan-windteal": {
    ...
    "en": 'Jiyan',
    "tone_zh": '风主青',
    "tone_en": 'Windborne Teal',
    "name_zh": '忌炎 · 风主青',
    "name_en": 'Jiyan · Windborne Teal',
    "family": '青',
    "source": '鸣潮',
    "kind": 'cat',
    "colors": ['#018D8D', '#84C3BF', '#C4A45A', '#9B9D9B', '#60606F', '#274D4F'],
    "dark": ['#006464', '#5B9A97', '#9A7D33', '#747674', '#3D3D4B', '#002B2D'],
    "light": ['#67B5B4', '#BDEEEA', '#EDD095', '#C7C8C7', '#898895', '#567374'],
    "bg": '#F1F6F6',
    "bg2": '#DCE8E7',
    "ink": '#1B3737',
    "muted": '#798686',
    "seq": ['#EFF8F8', '#DFEFEE', '#CEE5E5', '#BEDDDC', '#ADD3D3', '#9AC8C8', '#85BDBC', '#6EB1B0', '#5BA8A7', '#479F9E', '#2E9695', '#018D8D', '#018080', '#007474', '#006666', '#005959', '#004A4A', '#003C3C', '#003C3C'],
    "div": ['#0A4A4A', '#075F5F', '#017474', '#298989', '#459E9E', '#6BB2B2', '#92C7C6', '#B8DAD9', '#DDECEB', '#EAE9E0', '#E0D2B8', '#D1BB92', '#BDA46F', '#A98E4F', '#937938', '#7E6523', '#67521F', '#50401A', '#50401A'],
    "flow": ['#CFF2EF', '#C2EEE7', '#B4E9DC', '#A9E5D0', '#9FDFC1', '#99DAB1', '#95D3A0', '#8DCB9E', '#87C29F', '#82B89E', '#80B09D', '#7FA79A', '#71A195', '#609B91', '#4D968E', '#36908B', '#108A8A', '#008488', '#147D86', '#237582', '#2F6E7D', '#376877', '#3D6170', '#415B68', '#3C555E', '#374E56', '#32474C', '#2E4244', '#2B3C3E', '#2A3A3B'],
    "cyclic": ['#A8946C', '#A0966B', '#98986D', '#8E9B70', '#849D76', '#789F7E', '#6DA188', '#62A292', '#5BA29D', '#57A2A5', '#56A1AF', '#5B9FB6', '#659DBC', '#6F9ABF', '#7B98C0', '#8596C0', '#8F93BD', '#9990BA', '#A38DB5', '#AE8BAE', '#B788A4', '#BD8799', '#C1868E', '#C18784', '#BF897C', '#BB8B76', '#B68D71', '#B0906D', '#AA936C', '#A8946C'],
    "wheel": [{'i': 0, 'L': 52.9, 'C': 32.2, 'h': 196.4}, {'i': 1, 'L': 74.6, 'C': 21.4, 'h': 191.9}, {'i': 2, 'L': 68.8, 'C': 42.5, 'h': 86.5}, {'i': 3, 'L': 64.5, 'C': 1.4, 'h': 144.4}, {'i': 4, 'L': 41.2, 'C': 9.1, 'h': 291.5}, {'i': 5, 'L': 30.2, 'C': 14.0, 'h': 202.7}],
    "ramp_stats": {'seq': {'L_range': 74.8, 'L_min': 22.2, 'L_max': 96.9, 'monotonic': True, 'total_dE': 82.0, 'uniformity': 0.609}, 'div': {'L_range': 67.8, 'L_min': 28.0, 'L_max': 95.8, 'monotonic': False, 'total_dE': 146.4, 'uniformity': 0.696}, 'flow': {'L_range': 69.9, 'L_min': 23.1, 'L_max': 93.0, 'monotonic': True, 'total_dE': 112.8, 'uniformity': 0.641}, 'cyclic': {'L_range': 0.5, 'L_min': 61.7, 'L_max': 62.3, 'monotonic': True, 'total_dE': 124.5, 'uniformity': 0.558}},
    "cvd_grade": 'B',
    "safe_set": [0, 1, 2, 5],
    "orders": {'smooth': [0, 1, 2, 3, 4, 5], 'distinct': [0, 1, 5, 2, 4, 3], 'hue': [2, 1, 0, 5, 3, 4], 'light': [1, 2, 3, 0, 4, 5]},
    "min_de": 18.9,
    "cvd": {'protan': 9.4, 'deutan': 9.5, 'tritan': 16.8},
  },
  "gojo-sky": {
    "slug": 'gojo-sky',
    "zh": '五条悟',
  ...
  "saber-knightblue": {
    "slug": 'saber-knightblue',
    "zh": '阿尔托莉雅',
    "en": 'Artoria',
    "tone_zh": '骑士蓝金',
    "tone_en": 'Knight Blue',
    "name_zh": '阿尔托莉雅 · 骑士蓝金',
    "name_en": 'Artoria · Knight Blue',
    "family": '蓝',
    "source": 'Fate/Grand Order',
    "kind": 'cat',
    "colors": ['#4F72C4', '#34437B', '#4C4E51', '#88A7DC', '#B5B7BA', '#D4B45A'],
    "dark": ['#174E9C', '#022357', '#2A2C2F', '#5F80B3', '#8D8F92', '#A98C31'],
    "light": ['#899BDF', '#636A99', '#737577', '#BCD2FE', '#E2E3E6', '#FEE19A'],
    "bg": '#F4F5FA',
    "bg2": '#E3E5F1',
    "ink": '#2B324A',
    "muted": '#818390',
    "seq": ['#F5F6FF', '#E8EAFA', '#DBDEF5', '#CCD1F0', '#BDC4EA', '#ADB6E4', '#9CA8DE', '#8A9AD8', '#788CD1', '#6680CB', '#5474C5', '#476AB9', '#3D60AD', '#3257A0', '#2A4D92', '#264480', '#233B70', '#1F3360', '#1F3360'],
    "div": ['#32435E', '#3F567A', '#4B6996', '#617DAB', '#7892BE', '#93A8CE', '#AFBEDD', '#CBD4E8', '#E5E9F2', '#EDE9E0', '#E1D3B3', '#D2BC8A', '#BEA465', '#A98E44', '#93792B', '#7D6613', '#665313', '#4F4112', '#4F4112'],
    "flow": ['#FFE9B8', '#F4E8B6', '#E8E7B6', '#DCE5B8', '#CFE2BB', '#C2DFBE', '#B7DBC2', '#AED5C5', '#A8CFC7', '#9EC8C6', '#8BC2C2', '#78BCC0', '#61B5BF', '#46AEBE', '#24A7BF', '#009EBC', '#0094B6', '#008BB2', '#0082AC', '#0079A3', '#147098', '#30698A', '#3C637D', '#445D72', '#455768', '#3F4F62', '#3B475C', '#373F55', '#34384F', '#32354D'],
    "cyclic": ['#AD934C', '#A0984D', '#919C50', '#80A059', '#6BA365', '#52A675', '#34A886', '#02A997', '#00A7A5', '#00A6B3', '#00A4C1', '#00A2D1', '#319EDC', '#579ADE', '#7096DD', '#8292DB', '#948ED6', '#A689CF', '#B783C5', '#C77EB6', '#D37AA5', '#DA7893', '#DB7982', '#DA7B74', '#D57F68', '#CE845D', '#C78955', '#BC8D4F', '#B1924C', '#AD934C'],
    "wheel": [{'i': 0, 'L': 49.1, 'C': 48.4, 'h': 285.3}, {'i': 1, 'L': 29.8, 'C': 35.8, 'h': 289.5}, {'i': 2, 'L': 33.1, 'C': 2.1, 'h': 266.1}, {'i': 3, 'L': 68.0, 'C': 30.3, 'h': 274.6}, {'i': 4, 'L': 74.3, 'C': 1.8, 'h': 265.8}, {'i': 5, 'L': 74.4, 'C': 49.4, 'h': 89.0}],
    "ramp_stats": {'seq': {'L_range': 75.1, 'L_min': 22.0, 'L_max': 97.0, 'monotonic': True, 'total_dE': 87.8, 'uniformity': 0.692}, 'div': {'L_range': 67.7, 'L_min': 28.1, 'L_max': 95.8, 'monotonic': False, 'total_dE': 151.0, 'uniformity': 0.719}, 'flow': {'L_range': 70.2, 'L_min': 22.9, 'L_max': 93.0, 'monotonic': True, 'total_dE': 116.2, 'uniformity': 0.633}, 'cyclic': {'L_range': 0.5, 'L_min': 61.7, 'L_max': 62.2, 'monotonic': True, 'total_dE': 165.5, 'uniformity': 0.71}},
    "cvd_grade": 'A',
    "safe_set": [0, 1, 2, 3, 4, 5],
    "orders": {'smooth': [0, 1, 2, 3, 4, 5], 'distinct': [0, 3, 1, 5, 4, 2], 'hue': [5, 3, 0, 1, 4, 2], 'light': [5, 4, 3, 0, 2, 1]},
    "min_de": 17.1,
    "cvd": {'protan': 16.7, 'deutan': 16.9, 'tritan': 14.6},
  },
  "raiden-electro": {
    "slug": 'raiden-electro',
    "zh": '雷电将军',
  ...
  "yinlin-violetgold": {
    "slug": 'yinlin-violetgold',
    "zh": '吟霖',
    "en": 'Yinlin',
    "tone_zh": '紫金雷',
    "tone_en": 'Violet Gold',
    "name_zh": '吟霖 · 紫金雷',
    "name_en": 'Yinlin · Violet Gold',
    "family": '紫',
    "source": '鸣潮',
    "kind": 'cat',
    "colors": ['#8E53BB', '#543E64', '#6E7283', '#AF8DC5', '#B9B5BD', '#D4B45A'],
    "dark": ['#662D94', '#311D41', '#4A4E5E', '#87669D', '#918D95', '#A98C31'],
    "light": ['#B483D6', '#796686', '#989BA9', '#D7BBE8', '#E5E2E8', '#FEE19A'],
    "bg": '#F8F3FA',
    "bg2": '#EBE2F1',
    "ink": '#3D2B4A',
    "muted": '#8A8090',
    "seq": ['#FBF4FF', '#F4E8FA', '#EAD9F4', '#E1CBEE', '#D7BBE8', '#CCABE1', '#C29BDA', '#B68BD3', '#AB7BCC', '#A16CC6', '#965EC0', '#8B51B8', '#7F48AB', '#733E9D', '#68368F', '#5C317E', '#502B6E', '#46265F', '#46265F'],
    "div": ['#54346C', '#6C418D', '#864FAF', '#9B64C3', '#B07AD6', '#C394E3', '#D5B0ED', '#E4CAF3', '#F0E5F7', '#F0E7E2', '#E2D2B4', '#D2BC8A', '#BEA465', '#A98E44', '#93792B', '#7D6613', '#665313', '#4F4112', '#4F4112'],
    "flow": ['#FFE9B8', '#FFE3BA', '#FFDCB9', '#FFD6B8', '#FCD0BA', '#F7CABC', '#EEC3BE', '#E3BDBF', '#DEB4BA', '#DDAAB3', '#DC9EAC', '#DA91A6', '#D585A0', '#C4819E', '#B47E9A', '#A57A94', '#97768E', '#8A7187', '#8A6A86', '#896185', '#885784', '#874C83', '#853F82', '#793B7A', '#693B6F', '#5C3A64', '#503859', '#47364F', '#3F3446', '#3D3343'],
    "cyclic": ['#AC9455', '#9F9755', '#929B59', '#829F60', '#70A26B', '#5BA579', '#46A688', '#2DA797', '#0AA7A6', '#00A6B3', '#00A4C0', '#1DA2CC', '#449ED3', '#5F9AD6', '#7596D5', '#8692D3', '#958ECF', '#A48AC9', '#B286C1', '#C182B4', '#CC7EA5', '#D27C94', '#D57D86', '#D37F79', '#D0826D', '#C98664', '#C38A5D', '#B98E58', '#AF9255', '#AC9455'],
    "wheel": [{'i': 0, 'L': 46.3, 'C': 63.2, 'h': 313.9}, {'i': 1, 'L': 30.0, 'C': 25.8, 'h': 313.4}, {'i': 2, 'L': 48.2, 'C': 10.1, 'h': 282.9}, {'i': 3, 'L': 63.5, 'C': 33.6, 'h': 314.0}, {'i': 4, 'L': 74.2, 'C': 4.6, 'h': 309.2}, {'i': 5, 'L': 74.4, 'C': 49.4, 'h': 89.0}],
    "ramp_stats": {'seq': {'L_range': 75.0, 'L_min': 22.0, 'L_max': 97.0, 'monotonic': True, 'total_dE': 83.1, 'uniformity': 0.695}, 'div': {'L_range': 67.8, 'L_min': 27.9, 'L_max': 95.7, 'monotonic': False, 'total_dE': 151.9, 'uniformity': 0.697}, 'flow': {'L_range': 70.1, 'L_min': 22.9, 'L_max': 93.0, 'monotonic': True, 'total_dE': 113.0, 'uniformity': 0.63}, 'cyclic': {'L_range': 0.5, 'L_min': 61.8, 'L_max': 62.3, 'monotonic': True, 'total_dE': 155.6, 'uniformity': 0.685}},
    "cvd_grade": 'A',
    "safe_set": [0, 1, 2, 3, 4, 5],
    "orders": {'smooth': [0, 1, 2, 3, 4, 5], 'distinct': [0, 3, 1, 5, 2, 4], 'hue': [5, 1, 0, 3, 4, 2], 'light': [5, 4, 3, 2, 0, 1]},
    "min_de": 18.7,
    "cvd": {'protan': 16.3, 'deutan': 14.6, 'tritan': 13.7},
  },
  "amiya-originium": {
    "slug": 'amiya-originium',
    "zh": '阿米娅',
    "en": 'Amiya',
    "tone_zh": '源石紫',
    "tone_en": 'Originium Violet',
    "name_zh": '阿米娅 · 源石紫',
    "name_en": 'Amiya · Originium Violet',
    "family": '紫',
    "source": '明日方舟',
    "kind": 'cat',
    "colors": ['#6053C0', '#4A4167', '#6F798A', '#9B91D1', '#B8B6C0', '#D4B048'],
    "dark": ['#323099', '#272044', '#4A5465', '#736BA9', '#908E98', '#A8881B'],
    "light": ['#907FD8', '#716888', '#9BA2B0', '#C7BEF2', '#E4E3EB', '#FFDD8C'],
    "bg": '#F6F4FB',
    "bg2": '#E8E3F3',
    "ink": '#352E4F',
    "muted": '#868193',
    "seq": ['#F8F5FF', '#EEE8FB', '#E3DBF6', '#D6CDF1', '#C9BDEB', '#BCAEE6', '#AE9FE0', '#A190DA', '#9382D5', '#8675CF', '#7868C9', '#6A5CC4', '#5C50BB', '#5147AC', '#483E9F', '#40388C', '#3A327A', '#342C68', '#342C68'],
    "div": ['#433976', '#55499A', '#6859BF', '#7E6DD4', '#9583E5', '#AD9BF0', '#C4B4F7', '#D9CDFA', '#ECE6FA', '#F0E7E1', '#E4D1B0', '#D4BB83', '#C0A45C', '#AB8E38', '#95791E', '#7F6601', '#685206', '#514008', '#514008'],
    "flow": ['#ECE9F9', '#ECE3FB', '#EFDBFA', '#F4D2F8', '#FBC8F1', '#FFBFE3', '#FFB6D1', '#FFADC0', '#FFA3C3', '#FE9ACC', '#EE98D2', '#DD97D7', '#CA96D9', '#B996DA', '#A895D9', '#9791CC', '#8A89BA', '#8082A9', '#787C9A', '#717594', '#6A6D97', '#63649A', '#5D599C', '#584D9E', '#52468A', '#4C4276', '#453C64', '#403955', '#3A3548', '#393545'],
    "cyclic": ['#AD9350', '#A19751', '#929B55', '#829F5C', '#6FA368', '#58A576', '#40A787', '#1FA896', '#00A7A5', '#00A6B2', '#00A5C0', '#00A2CF', '#389FD7', '#599ADA', '#7196D9', '#8392D7', '#948ED3', '#A38ACD', '#B385C3', '#C280B6', '#CF7CA6', '#D67A95', '#D87B85', '#D77D77', '#D3806B', '#CC8461', '#C5895A', '#BB8D54', '#B19251', '#AD9350'],
    "wheel": [{'i': 0, 'L': 42.0, 'C': 65.4, 'h': 301.5}, {'i': 1, 'L': 30.0, 'C': 24.7, 'h': 302.2}, {'i': 2, 'L': 50.6, 'C': 10.5, 'h': 270.8}, {'i': 3, 'L': 63.2, 'C': 36.1, 'h': 299.1}, {'i': 4, 'L': 74.5, 'C': 5.5, 'h': 298.3}, {'i': 5, 'L': 73.2, 'C': 56.4, 'h': 88.2}],
    "ramp_stats": {'seq': {'L_range': 75.0, 'L_min': 22.1, 'L_max': 97.0, 'monotonic': True, 'total_dE': 85.6, 'uniformity': 0.721}, 'div': {'L_range': 67.7, 'L_min': 27.9, 'L_max': 95.6, 'monotonic': False, 'total_dE': 151.3, 'uniformity': 0.689}, 'flow': {'L_range': 69.8, 'L_min': 23.2, 'L_max': 93.0, 'monotonic': True, 'total_dE': 126.2, 'uniformity': 0.752}, 'cyclic': {'L_range': 0.5, 'L_min': 61.8, 'L_max': 62.3, 'monotonic': True, 'total_dE': 160.8, 'uniformity': 0.695}},
    "cvd_grade": 'A',
    "safe_set": [0, 1, 2, 3, 4, 5],
    "orders": {'smooth': [0, 1, 2, 3, 4, 5], 'distinct': [0, 3, 1, 5, 2, 4], 'hue': [5, 3, 0, 1, 4, 2], 'light': [4, 5, 3, 2, 0, 1]},
    "min_de": 16.4,
    "cvd": {'protan': 16.1, 'deutan': 15.4, 'tritan': 10.6},
  },
  "nezuko-crimson-pink": {
  ...
  "texas-inkgray": {
    ...
    "en": 'Texas',
    "tone_zh": '冷墨灰',
    "tone_en": 'Cold Ink Gray',
    "name_zh": '德克萨斯 · 冷墨灰',
    "name_en": 'Texas · Cold Ink Gray',
    "family": '中性',
    "source": '明日方舟',
    "kind": 'cat',
    "colors": ['#38475F', '#7A5A4A', '#60636A', '#5B7599', '#8994A5', '#B6B8BA'],
    "dark": ['#15263C', '#543728', '#3D4046', '#345173', '#636E7E', '#8E9092'],
    "light": ['#626D81', '#9F8376', '#898B91', '#8B9EBC', '#B6BFCD', '#E3E4E6'],
    "bg": '#F4F5F7',
    "bg2": '#E4E5E9',
    "ink": '#2F333B',
    "muted": '#828488',
    "seq": ['#F5F6F9', '#E0E2E8', '#CBCFD8', '#B8BEC9', '#A6ADBB', '#959DAD', '#848DA0', '#737E93', '#647086', '#526078', '#485770', '#44536A', '#3F4D64', '#3A475D', '#364255', '#333E4F', '#303949', '#2D3543', '#2D3543'],
    "div": ['#354357', '#435670', '#52698B', '#677D9F', '#7D92B2', '#96A8C4', '#B2BED5', '#CCD4E3', '#E5E9F0', '#ECE8E7', '#DED1CB', '#CFBAAF', '#BCA294', '#A98B7C', '#957666', '#806252', '#684F43', '#513E35', '#513E35'],
    "flow": ['#DEEDFA', '#D6E5F4', '#CCDCED', '#C4D4E7', '#BACCE1', '#B1C4DA', '#A6BCD6', '#9BB3D1', '#90ACCD', '#85A3C8', '#7E9BBF', '#7A93B5', '#758CAB', '#7185A1', '#6D7E98', '#6B7891', '#6B728B', '#6B6D86', '#6B6880', '#6B6279', '#6A5C72', '#69566A', '#655061', '#5B4C5E', '#524758', '#494454', '#42414F', '#3B3C4A', '#343844', '#323741'],
    "cyclic": ['#BA8C75', '#B58E70', '#AF916D', '#A9946C', '#A1966C', '#99986D', '#8F9B70', '#859D76', '#799F7E', '#6DA087', '#63A192', '#5BA29C', '#57A2A6', '#56A1AF', '#5C9FB6', '#669DBC', '#709ABF', '#7C98C0', '#8695BF', '#9093BD', '#9A90BA', '#A48DB5', '#AE8BAE', '#B788A5', '#BE869A', '#C1868F', '#C18785', '#BF897D', '#BB8B77', '#BA8C75'],
    "wheel": [{'i': 0, 'L': 29.8, 'C': 16.1, 'h': 273.3}, {'i': 1, 'L': 41.1, 'C': 18.0, 'h': 53.0}, {'i': 2, 'L': 41.9, 'C': 4.4, 'h': 274.8}, {'i': 3, 'L': 48.6, 'C': 22.5, 'h': 270.5}, {'i': 4, 'L': 61.0, 'C': 10.3, 'h': 268.4}, {'i': 5, 'L': 74.7, 'C': 1.3, 'h': 255.7}],
    "ramp_stats": {'seq': {'L_range': 74.9, 'L_min': 22.0, 'L_max': 96.9, 'monotonic': True, 'total_dE': 116.6, 'uniformity': 0.495}, 'div': {'L_range': 67.8, 'L_min': 28.0, 'L_max': 95.8, 'monotonic': False, 'total_dE': 155.1, 'uniformity': 0.696}, 'flow': {'L_range': 70.0, 'L_min': 23.0, 'L_max': 93.0, 'monotonic': True, 'total_dE': 104.4, 'uniformity': 0.535}, 'cyclic': {'L_range': 0.5, 'L_min': 61.8, 'L_max': 62.3, 'monotonic': True, 'total_dE': 124.2, 'uniformity': 0.558}},
    "cvd_grade": 'B',
    "safe_set": [0, 1, 2, 3, 4, 5],
    "orders": {'smooth': [0, 1, 2, 3, 4, 5], 'distinct': [0, 4, 2, 5, 1, 3], 'hue': [1, 3, 0, 5, 4, 2], 'light': [5, 4, 3, 2, 1, 0]},
    "min_de": 12.9,
    "cvd": {'protan': 12.4, 'deutan': 13.0, 'tritan': 13.2},
  },
  "hollowknight-pale": {
    "slug": 'hollowknight-pale',
    "zh": '小骑士',
    "en": 'The Knight',
    "tone_zh": '骨白深渊',
    "tone_en": 'Pale Abyss',
    "name_zh": '小骑士 · 骨白深渊',
    "name_en": 'The Knight · Pale Abyss',
    "family": '中性',
    "source": '空洞骑士',
    "kind": 'cat',
    "colors": ['#C5C0AD', '#A09E98', '#838171', '#7B5E48', '#414755', '#3D8BA7'],
    "dark": ['#9C9885', '#797771', '#5E5C4C', '#553B26', '#202633', '#006580'],
    "light": ['#F1EDDD', '#CBC9C5', '#ADAB9E', '#A18775', '#696D79', '#7EB4CA'],
    "bg": '#F5F5F4',
    "bg2": '#E6E5E3',
    "ink": '#34332D',
    "muted": '#848481',
    "seq": ['#F7F6F4', '#EBEAE5', '#DEDCD5', '#D3D0C8', '#C7C4BA', '#BAB7AA', '#AEA99A', '#A49F8F', '#969180', '#8A8574', '#7E7A6A', '#747060', '#696556', '#5E5A4C', '#545144', '#49463B', '#423F34', '#37352B', '#37352B'],
    "div": ['#1E4756', '#225B6F', '#26708A', '#41849E', '#5C99B1', '#7DAEC3', '#9FC3D4', '#BFD7E2', '#E0EAEF', '#EAE8E7', '#DDD1C9', '#CEBAAC', '#BAA290', '#A78C77', '#937762', '#7E634E', '#675140', '#503F33', '#503F33'],
    "flow": ['#EFEBDB', '#E8E1CF', '#E0D5C1', '#D8CAB5', '#D1C0A9', '#C9BA9D', '#C0B593', '#B5AF88', '#A9AB7E', '#9BA575', '#989F6F', '#9C996B', '#9E9268', '#9F8D67', '#9F8767', '#9E8267', '#9B7C67', '#977668', '#917067', '#8B6864', '#836160', '#7C5A5C', '#745359', '#694C56', '#5E4856', '#534453', '#48404F', '#3F3D4A', '#363944', '#333741'],
    "cyclic": ['#B58E70', '#B0906E', '#A9936C', '#A2966B', '#9B986C', '#919A6F', '#879D75', '#7B9F7B', '#70A085', '#65A190', '#5DA29A', '#57A2A4', '#56A1AE', '#5A9FB5', '#639DBB', '#6D9BBF', '#7898C0', '#8396C0', '#8D93BE', '#9891BB', '#A28EB6', '#AC8BB0', '#B688A7', '#BD879B', '#C18690', '#C18786', '#BF897D', '#BB8B77', '#B78D72', '#B58E70'],
    "wheel": [{'i': 0, 'L': 77.6, 'C': 10.3, 'h': 98.5}, {'i': 1, 'L': 65.1, 'C': 3.4, 'h': 96.7}, {'i': 2, 'L': 53.7, 'C': 9.2, 'h': 103.9}, {'i': 3, 'L': 42.3, 'C': 19.2, 'h': 63.3}, {'i': 4, 'L': 30.1, 'C': 9.2, 'h': 276.7}, {'i': 5, 'L': 54.3, 'C': 26.6, 'h': 235.4}],
    "ramp_stats": {'seq': {'L_range': 74.8, 'L_min': 22.1, 'L_max': 96.9, 'monotonic': True, 'total_dE': 121.6, 'uniformity': 0.458}, 'div': {'L_range': 67.7, 'L_min': 28.0, 'L_max': 95.7, 'monotonic': False, 'total_dE': 150.5, 'uniformity': 0.72}, 'flow': {'L_range': 69.9, 'L_min': 23.1, 'L_max': 93.0, 'monotonic': True, 'total_dE': 119.0, 'uniformity': 0.527}, 'cyclic': {'L_range': 0.5, 'L_min': 61.8, 'L_max': 62.2, 'monotonic': True, 'total_dE': 124.8, 'uniformity': 0.54}},
    "cvd_grade": 'B',
    "safe_set": [0, 2, 3, 4, 5],
    "orders": {'smooth': [0, 1, 2, 3, 4, 5], 'distinct': [0, 1, 2, 4, 5, 3], 'hue': [3, 5, 0, 1, 2, 4], 'light': [0, 1, 5, 2, 3, 4]},
    "min_de": 10.9,
    "cvd": {'protan': 10.8, 'deutan': 10.8, 'tritan': 9.9},
  },
  "mario-primary": {
    "slug": 'mario-primary',
    "zh": '马力欧',
